# -*- coding: utf-8 -*-
"""Generiše PowerPoint prezentaciju o Velimiru Bati Živojinoviću."""
...
def dodaj_traku(slide, top, height, boja):
    sh = slide.shapes.add_shape(1, 0, top, SW, height)  # 1 = pravougaonik
    sh.fill.solid()
...
def naslov_slajda(slide, broj, naslov):
    """Standardno zaglavlje za sadržajne slajdove."""
...
dodaj_traku(s, Inches(2.55), Emu(50000), ZLATNA)
dodaj_traku(s, Inches(4.55), Emu(50000), ZLATNA)

txt(s, Inches(1), Inches(0.95), Inches(11.3), Inches(0.6),
    "MATURSKA / SEMINARSKA PREZENTACIJA", 16, ZLATNA, bold=True, align=PP_ALIGN.CENTER)
txt(s, Inches(0.8), Inches(2.7), Inches(11.7), Inches(1.6),
    "VELIMIR „BATA“ ŽIVOJINOVIĆ", 48, BELA, bold=True, align=PP_ALIGN.CENTER,
    anchor=MSO_ANCHOR.MIDDLE)
txt(s, Inches(1), Inches(4.65), Inches(11.3), Inches(1.1),
    "Život i uloge — s posebnim osvrtom na ulogu Gvozdena\nu filmu „Lepa sela lepo gore“ (1996)",
    22, SVETLA, align=PP_ALIGN.CENTER, italic=True)
txt(s, Inches(1), Inches(6.45), Inches(11.3), Inches(0.6),
    "1933 — 2016  •  legenda jugoslovenskog i srpskog filma", 15, ZLATNA,
...
bullets(s, Inches(0.7), Inches(1.7), Inches(7.4), Inches(5.4), [
    ...
    ("Postao je prepoznatljiv kao simbol „partizanskih“ ratnih filmova i otelotvorenje hrabrog, narodnog junaka.", 0),
    ("Voljen kod publike zbog topline, autentičnosti i snažne ekranske pojave.", 0),
    ("U drugom delu života bavio se i politikom.", 0),
], size=19, razmak=12)
# bočni panel
p = dodaj_traku(s, Inches(8.4), Inches(1.7), TAMNO_CRVENA)
p.height = Inches(5.1); p.width = Inches(4.3); p.left = Inches(8.55)
txt(s, Inches(8.75), Inches(1.95), Inches(3.9), Inches(0.6),
    "LIČNA KARTA", 18, ZLATNA, bold=True)
bullets(s, Inches(8.75), Inches(2.65), Inches(3.9), Inches(4.0), [
    ("Puno ime: Velimir Živojinović", 0),
    ("Nadimak: Bata", 0),
    ("Rođen: 5. jun 1933, Koraćica", 0),
    ("Preminuo: 22. maj 2016, Beograd", 0),
    ("Zanimanje: glumac, političar", 0),
], size=15, boja=BELA, razmak=12, bullet_boja=ZLATNA)
...
bullets(s, Inches(1.0), Inches(1.7), Inches(11.3), Inches(5.4), [
    ("Rođen je 5. juna 1933. godine u selu Koraćica, u podnožju planine Kosmaj, blizu Mladenovca.", 0),
    ...
    ("Diplomirao je na Akademiji za pozorišnu umetnost u Beogradu (danas Fakultet dramskih umetnosti).", 0),
    ("Karijeru je započeo u pozorištu, a ubrzo prešao na film, gde je stekao najveću slavu.", 0),
    ("Bio je član ansambla beogradskih pozorišta i jedan od najtraženijih glumaca svoje generacije.", 0),
], size=19, razmak=13)
...
bullets(s, Inches(1.0), Inches(1.65), Inches(11.3), Inches(5.5), [
    ("Najveću popularnost stekao je u partizanskim ratnim filmovima, gde je tumačio hrabre borce i komandante:", 0),
    ("„Bitka na Neretvi“ (1969)", 1),
    ("„Most“ (1969)", 1),
    ("„Valter brani Sarajevo“ (1972)", 1),
    ("„Sutjeska“ (1973) — gde je glumio uz Ričarda Bartona", 1),
    ("Igrao je i u komedijama, dramama i istorijskim filmovima, pokazujući veliki glumački raspon.", 0),
    ("Sarađivao je sa najznačajnijim rediteljima jugoslovenske kinematografije.", 0),
    ("Njegova pojava na ekranu postala je zaštitni znak čitave epohe domaćeg filma.", 0),
], size=18, razmak=9)
...
bullets(s, Inches(1.0), Inches(1.7), Inches(11.3), Inches(5.4), [
    ...
    ("Zahvaljujući televiziji, postao je omiljen i prepoznatljiv u svakom domu bivše Jugoslavije.", 0),
    ("Njegov glas i lik vezuju se za zlatno doba domaće televizijske produkcije.", 0),
], size=19, razmak=13)
...
bullets(s, Inches(1.0), Inches(1.7), Inches(11.3), Inches(5.4), [
    ("U drugom delu života Bata Živojinović se aktivno bavio politikom.", 0),
    ("Bio je član Socijalističke partije Srbije (SPS).", 0),
    ("Više puta je biran za narodnog poslanika u Skupštini.", 0),
    ("Njegov ulazak u politiku bio je propraćen velikom pažnjom javnosti, upravo zbog ogromne popularnosti koju je stekao kao glumac.", 0),
    ("Iako podeljenih mišljenja o njegovom političkom angažmanu, publika ga je pre svega pamtila kao velikog umetnika.", 0),
], size=19, razmak=13)
...
bullets(s, Inches(0.7), Inches(1.7), Inches(7.5), Inches(5.4), [
    ...
    ("Radnja prati grupu srpskih boraca koji ostaju zarobljeni u tunelu, okruženi neprijateljskim snagama.", 0),
    ("Film kroz potresne scene prikazuje besmisao rata i raspad nekadašnjeg „bratstva i jedinstva“.", 0),
    ("Smatra se antiratnim filmom — ne slavi rat, već pokazuje njegovu tragediju i ljudsku patnju.", 0),
], size=18, razmak=11)
p = dodaj_traku(s, Inches(8.45), Inches(1.7), TAMNO_CRVENA)
p.height = Inches(5.1); p.width = Inches(4.3); p.left = Inches(8.55)
txt(s, Inches(8.8), Inches(1.95), Inches(3.8), Inches(0.6),
    "ZANIMLJIVO", 18, ZLATNA, bold=True)
bullets(s, Inches(8.8), Inches(2.7), Inches(3.85), Inches(4.0), [
    ("Tunel u filmu je simbol — bezizlazna situacija i zarobljenost u mržnji rata.", 0),
...
bullets(s, Inches(1.0), Inches(1.65), Inches(11.3), Inches(5.5), [
    ...
    ("Gvozden je nekadašnji radnik i čovek koji je iskreno verovao u ideale „bratstva i jedinstva“ socijalističke Jugoslavije.", 0),
    ("On predstavlja stariju generaciju — onu koja je gradila zajedničku zemlju i ne može da prihvati da se ona ruši u krvi.", 0),
    ("Kako rat odmiče, Gvozden sve više gubi nadu i razočaran je u sve oko sebe.", 0),
    ("Njegov lik je tragičan: simbol sloma jednog sistema vrednosti i jedne epohe.", 0),
    ("U trenutku potpunog očaja, Gvozden donosi sudbonosnu, samoubilačku odluku — što je jedna od najupečatljivijih scena filma.", 0),
], size=18, razmak=10)
...
bullets(s, Inches(1.0), Inches(1.7), Inches(11.3), Inches(5.4), [
    ...
    ("Time se stvara snažan kontrast: nekadašnji „heroj bratstva i jedinstva“ suočava se sa raspadom svega u šta je verovao.", 0),
...
bullets(s, Inches(1.0), Inches(1.7), Inches(11.3), Inches(5.4), [
    ("Tokom karijere osvojio je brojne nagrade, među kojima i prestižne Zlatne arene na filmskom festivalu u Puli.", 0),
    ...
    ("Preminuo je 22. maja 2016. godine u Beogradu, u 83. godini života.", 0),
    ("Njegovi filmovi i danas se rado gledaju, a lik i delo ostaju deo kulturnog nasleđa regiona.", 0),
], size=19, razmak=13)
...
dodaj_traku(s, Inches(3.0), Emu(50000), ZLATNA)
txt(s, Inches(1), Inches(2.4), Inches(11.3), Inches(1.2),
    "HVALA NA PAŽNJI!", 44, BELA, bold=True, align=PP_ALIGN.CENTER,
    anchor=MSO_ANCHOR.MIDDLE)
txt(s, Inches(1), Inches(3.7), Inches(11.3), Inches(0.8),
...
txt(s, Inches(1), Inches(6.4), Inches(11.3), Inches(0.6),
    "Izvori: Wikipedia, baze podataka o filmu, dostupni filmski i biografski materijali",
    13, SVETLA, align=PP_ALIGN.CENTER)
